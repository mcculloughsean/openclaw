...
const FIELD_LABELS: Record<string, string> = {
  ...
  "tools.web.search.kagi.apiKey": "Kagi Search API Key",
...
const FIELD_HELP: Record<string, string> = {
  ...
  "tools.web.search.provider": 'Search provider ("brave", "perplexity", or "kagi").',
  "tools.web.search.apiKey": "Brave Search API key (fallback: BRAVE_API_KEY env var).",
  "tools.web.search.kagi.apiKey":
    "Kagi API key (fallback: KAGI_API_KEY env var). Kagi is in closed beta - requires invitation.",
